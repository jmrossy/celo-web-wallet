...
function* sendTokenOld(params: SendTokenParams) {
...
export const {
  wrappedSaga: sendTokenOldSaga,
  reducer: sendTokenOldReducer,
  actions: sendTokenOldActions,
} = createMonitoredSaga<SendTokenParams>(sendTokenOld, { name: 'sendTokenOld' })
