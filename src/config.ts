...
const desktopUrls = {
  windows:
    'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.0.5/Celo-Wallet-1.0.5-win.exe',
  mac:
    'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.0.5/Celo-Wallet-1.0.5-mac.dmg',
  linux:
