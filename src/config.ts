...
const desktopUrls = {
  windows:
    'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.3.6/Celo-Wallet-1.3.6-win-x64.exe',
  mac: 'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.3.6/Celo-Wallet-1.3.6-mac.dmg',
  linux:
    'https://github.com/celo-tools/celo-web-wallet/releases/download/v1.3.6/Celo-Wallet-1.3.6-linux-x86_64.AppImage',
}
